...
Adapt/adopt/extend the `yml` files from one of your workflow folders. CCN allowed is 5 and  Duplication allowed is 3 lines
...
- test_sequence_count the name of a **passing** test
- test_valid_input the name of a **failing** test
